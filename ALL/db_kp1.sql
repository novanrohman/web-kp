...
(54001,'Devit Suwardiyanto, S.Si., M.T','1',1),
(54002,'Sepyan Purnama Kristanto, S.Kom.,M.Kom ','2',2),
(54003,'Moh. Dimyati Ayatullah, S.T., M.Kom','3',3),
(54004,'Dianni Yusuf, S.Kom, M.Kom','4',4);
...
insert  into `mahasiswa`(`id`,`nama_mahasiswa`,`nim`,`kelas`,`alamat`,`email`,`user_id`,`anggota_kelompok_id`) values 
...
(2,'dosen','202cb962ac59075b964b07152d234b70',1),
(3,'admin','202cb962ac59075b964b07152d234b70',2),
