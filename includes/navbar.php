...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="index3.html" class="brand-link">
    <img src="includes\img\poliwangi.png" alt="POLIWANGI" class="brand-image img-circle elevation-3" style="opacity: .8">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        <a href="index.php?page=index.php" class="d-block"><?php echo $_SESSION['username']; ?></a>
      </div>
    </div>
